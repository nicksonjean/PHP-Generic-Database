...
```php
// Create a new database connection using FBird/IBase engine for Firebird/Interbase dialects in the static arguments format
$connection = Connection::new(
    engine: 'fbird',
...
```php
// Create a new database connection using PDO FBird/IBase engine for Firebird/Interbase dialects in the static arguments format
$connection = Connection::new(
    engine: 'pdo',
    driver: 'firebird',
    host: $_ENV['FBIRD_HOST'],
