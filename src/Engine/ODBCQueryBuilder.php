...
use GenericDatabase\Engine\ODBC\QueryBuilder\Internal;

class ODBCQueryBuilder implements IQueryBuilder
{
    use Query;
    use Singleton;
    ...
    public static function limit(array|string ...$data): IQueryBuilder
    {
        return Internal::limit([
            'data' => $data, 'self' => self::getInstance(), 'connection' => ODBCConnection::getInstance()
        ]);
    }
    ...
    {
        return (new Builder($this->query, ODBCConnection::getInstance()))->build();
    }
    ...
    {
        return (new Builder($this->query, ODBCConnection::getInstance()))->buildRaw();
    }

    /** @noinspection PhpUnused */
    public function getValues(): array
    {
        return (new Builder($this->query, ODBCConnection::getInstance()))->getValues();
    }

    public function getAllMetadata(): object
    {
        return ODBCConnection::getInstance()->getAllMetadata();
    }
    ...
    private static function run($instance): string
    {
        ...
        $builder = new Builder($instance->query, ODBCConnection::getInstance());
    ...
    private static function afterRun($instance): void
    {
        ...
        ODBCConnection::getInstance()->query($query);
    }
    ...
    public function fetch(int $fetchStyle = null, mixed $fetchArgument = null, mixed $optArgs = null): mixed
    {
        ...
        return ODBCConnection::getInstance()->fetch($fetchStyle, $fetchArgument, $optArgs);
    }
    ...
    public function fetchAll(int $fetchStyle = null, mixed $fetchArgument = null, mixed $optArgs = null): array|bool
    {
        ...
        return ODBCConnection::getInstance()->fetchAll($fetchStyle, $fetchArgument, $optArgs);
    }
}
