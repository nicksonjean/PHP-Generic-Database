...
class MySQLiEngine implements IConnection
{
    ...
    public function fetch(int $fetchStyle = null, mixed $fetchArgument = null, mixed $optArgs = null): mixed
    {
        ...
        return match ($fetch) {
            MySQL::FETCH_OBJ,
            MySQL::FETCH_INTO,
            MySQL::FETCH_CLASS => Statements::internalFetchClassOrObject(self::$statement, $fetchArgument, $optArgs),
            MySQL::FETCH_COLUMN => Statements::internalFetchColumn(self::$statement, $fetchArgument),
            MySQL::FETCH_ASSOC => Statements::internalFetchAssoc(self::$statement),
            MySQL::FETCH_NUM => Statements::internalFetchNum(self::$statement),
            MySQL::FETCH_BOTH => Statements::internalFetchBoth(self::$statement),
    ...
    public function fetchAll(int $fetchStyle = null, mixed $fetchArgument = null, mixed $optArgs = null): mixed
    {
        ...
        return match ($fetch) {
            ...
            MySQL::FETCH_COLUMN => Statements::internalFetchAllColumn(self::$statement, $fetchArgument),
            MySQL::FETCH_ASSOC => Statements::internalFetchAllAssoc(self::$statement),
            MySQL::FETCH_NUM => Statements::internalFetchAllNum(self::$statement),
            MySQL::FETCH_BOTH => Statements::internalFetchAllBoth(self::$statement),
