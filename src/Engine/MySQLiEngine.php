...
class MySQLiEngine implements IConnection
{
    ...
    private const FETCH_ONE_METHODS = [
        MYSQLI_FETCH_OBJ => 'internalFetchClassOrObject',
        FETCH_OBJ => 'internalFetchClassOrObject',
        MYSQLI_FETCH_CLASS => 'internalFetchClassOrObject',
        FETCH_CLASS => 'internalFetchClassOrObject',
        MYSQLI_FETCH_INTO => 'internalFetchClassOrObject',
        FETCH_INTO => 'internalFetchClassOrObject',
        MYSQLI_FETCH_COLUMN => 'internalFetchColumn',
        FETCH_COLUMN => 'internalFetchColumn',
        MYSQLI_FETCH_ASSOC => 'internalFetchAssoc',
        FETCH_ASSOC => 'internalFetchAssoc',
        MYSQLI_FETCH_NUM => 'internalFetchNum',
        FETCH_NUM => 'internalFetchNum',
        MYSQLI_FETCH_BOTH => 'internalFetchBoth',
    ...
    private const FETCH_ALL_METHODS = [
        MYSQLI_FETCH_OBJ => 'internalFetchAllClassOrObjects',
        FETCH_OBJ => 'internalFetchAllClassOrObjects',
        MYSQLI_FETCH_CLASS => 'internalFetchAllClassOrObjects',
        FETCH_CLASS => 'internalFetchAllClassOrObjects',
        MYSQLI_FETCH_COLUMN => 'internalFetchAllColumn',
        FETCH_COLUMN => 'internalFetchAllColumn',
        MYSQLI_FETCH_ASSOC => 'internalFetchAllAssoc',
        FETCH_ASSOC => 'internalFetchAllAssoc',
        MYSQLI_FETCH_NUM => 'internalFetchAllNum',
        FETCH_NUM => 'internalFetchAllNum',
        MYSQLI_FETCH_BOTH => 'internalFetchAllBoth',
