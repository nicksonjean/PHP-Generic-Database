...
class Fetchs
{
     ...
     *
     * @param mysqli_stmt|mysqli_result|array $statement The statement to cache results from
     * @return string The statement identifier
     */
    private static function cacheResults(mysqli_stmt|mysqli_result|array $statement): string
    {
     ...
     *
     * @param mysqli_result|array $statement The statement resource
     * @return void
     */
    private static function handleFetchReset(mysqli_result|array $statement): void
    {
        if (!$statement) {
            return;
        }
