...
namespace GenericDatabase\Engine\JSON\Connection\Structure\Strategy;
 ...
 * work without calling private methods on JSONConnection.
 * StructureHandler injects itself via setStructureHandler() after construction.
 *
 * @package GenericDatabase\Engine\JSON\Connection\Structure\Strategy
 */
