...
namespace GenericDatabase\Engine\JSON\Connection;
...
{
    /**
     * JSON encoding option for pretty print.
     */
    public const ATTR_JSON_PRETTY_PRINT = 3001;

    /**
     * JSON encoding option for unescaped unicode.
     */
    public const ATTR_JSON_UNESCAPED_UNICODE = 3002;

    /**
     * JSON encoding option for unescaped slashes.
     */
    public const ATTR_JSON_UNESCAPED_SLASHES = 3003;

    /**
     * JSON encoding option for numeric check.
     */
    public const ATTR_JSON_NUMERIC_CHECK = 3004;

    /**
     * JSON decoding depth.
     */
    public const ATTR_JSON_DEPTH = 3005;
    ...
    /**
     * Get default JSON encoding flags.
     *
    ...
    public static function getDefaultEncodingFlags(): int
    {
        ...
        if (self::getAttribute(self::ATTR_JSON_PRETTY_PRINT) === true) {
            $flags |= JSON_PRETTY_PRINT;
        }
        if (self::getAttribute(self::ATTR_JSON_UNESCAPED_UNICODE) !== false) {
            $flags |= JSON_UNESCAPED_UNICODE;
        }
        if (self::getAttribute(self::ATTR_JSON_UNESCAPED_SLASHES) !== false) {
            $flags |= JSON_UNESCAPED_SLASHES;
        }
        if (self::getAttribute(self::ATTR_JSON_NUMERIC_CHECK) === true) {
