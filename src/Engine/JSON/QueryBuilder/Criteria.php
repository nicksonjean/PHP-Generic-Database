...
/**
 * Criteria class for JSON QueryBuilder.
...
class Criteria implements ICriteria
{
    ...
    /**
     * Parse JOIN criteria (not supported for JSON, returns empty array).
     *
     * @param array $arguments The arguments.
     * @return array
     */
    ...
    /**
     * Parse ON criteria (not supported for JSON, returns empty array).
     *
     * @param array $arguments The arguments.
     * @return array
     */
    ...
    public static function getWhereHaving(array $arguments): array
    {
        ...
        // Fallback when regex did not match OR matched with empty column (e.g. c.estado_id = e.id)
