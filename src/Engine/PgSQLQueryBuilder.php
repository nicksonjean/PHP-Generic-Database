...
use GenericDatabase\Engine\PgSQL\QueryBuilder\Query;
use GenericDatabase\Engine\PgSQL\QueryBuilder\Builder;
use GenericDatabase\Engine\PgSQL\QueryBuilder\Internal;

class PgSQLQueryBuilder implements IQueryBuilder
{
    use Query;
    use Singleton;
    ...
    {
        return PgSQLConnection::getInstance()->getAllMetadata();
    }
    ...
    private static function afterRun($instance): void
    {
        ...
        PgSQLConnection::getInstance()->query($query);
    }
    ...
    public function fetch(int $fetchStyle = null, mixed $fetchArgument = null, mixed $optArgs = null): mixed
    {
        ...
        return PgSQLConnection::getInstance()->fetch($fetchStyle, $fetchArgument, $optArgs);
    }
    ...
    public function fetchAll(int $fetchStyle = null, mixed $fetchArgument = null, mixed $optArgs = null): array|bool
    {
        ...
        return PgSQLConnection::getInstance()->fetchAll($fetchStyle, $fetchArgument, $optArgs);
    }
}
