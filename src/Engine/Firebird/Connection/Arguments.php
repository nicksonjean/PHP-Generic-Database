...
class Arguments
{
     ...
     */
    private static function callArgumentsByFormat(string $format, mixed $arguments): FirebirdConnection
    {
        $data = match ($format) {
     ...
     * @return FirebirdConnection
     */
    private static function callWithByStaticArray(array $arguments): FirebirdConnection
    {
        foreach ($arguments as $key => $value) {
            call_user_func_array([FirebirdConnection::getInstance(), 'set' . ucfirst($key)], [$value]);
        }
        return FirebirdConnection::getInstance();
    }
     ...
     * @noinspection PhpUnused
     */
    private static function callWithByStaticArgs(array $arguments): FirebirdConnection
    {
     ...
     * @throws ReflectionException
     */
    public static function call(string $name, array $arguments): FirebirdConnection
    {
        ...
        return match ($name) {
            ...
            default => call_user_func_array([FirebirdConnection::getInstance(), $name], $arguments)
        };
    }
}
