...
use GenericDatabase\Engine\CSV\Connection\DSN\DSNHandler;
...
use GenericDatabase\Engine\CSV\Connection\Arguments\ArgumentsHandler;
use GenericDatabase\Engine\CSV\Connection\Attributes\AttributesHandler;
...
use GenericDatabase\Engine\CSV\Connection\Transactions\TransactionsHandler;
use GenericDatabase\Engine\CSV\Connection\Arguments\Strategy\ArgumentsStrategy;
 ...
 *
 * @method static CSVConnection|void setDriver(mixed $value) Sets a driver from the database.
 * @method static CSVConnection|string getDriver($value = null) Retrieves a driver from the database.
 * @method static CSVConnection|void setHost(mixed $value) Sets a host from the database.
 * @method static CSVConnection|string getHost($value = null) Retrieves a host from the database.
 * @method static CSVConnection|void setPort(mixed $value) Sets a port from the database.
 * @method static CSVConnection|int getPort($value = null) Retrieves a port from the database.
 * @method static CSVConnection|void setUser(mixed $value) Sets a user from the database.
 * @method static CSVConnection|string getUser($value = null) Retrieves a user from the database.
 * @method static CSVConnection|void setPassword(mixed $value) Sets a password from the database.
 * @method static CSVConnection|string getPassword($value = null) Retrieves a password from the database.
 * @method static CSVConnection|void setDatabase(mixed $value) Sets a database name from the database.
 * @method static CSVConnection|string getDatabase($value = null) Retrieves a database name from the database.
 * @method static CSVConnection|void setOptions(mixed $value) Sets an options from the database.
 * @method static CSVConnection|array|null getOptions($value = null) Retrieves an options from the database.
 * @method static CSVConnection|void setStrcture(mixed $value) Sets an structure from the database.
 * @method static CSVConnection|array|null getStructure($value = null) Retrieves an structure from the database.*
 * @method static CSVConnection|static setConnected(mixed $value) Sets a connected status from the database.
 * @method static CSVConnection|mixed getConnected($value = null) Retrieves a connected status from the database.
 * @method static CSVConnection|void setDsn(mixed $value) Sets a dsn string from the database.
 * @method static CSVConnection|mixed getDsn($value = null) Retrieves a dsn string from the database.
 * @method static CSVConnection|void setAttributes(mixed $value) Sets an attributes from the database.
 * @method static CSVConnection|mixed getAttributes($value = null) Retrieves an attributes from the database.
 * @method static CSVConnection|void setCharset(mixed $value) Sets a charset from the database.
 * @method static CSVConnection|string getCharset($value = null) Retrieves a charset from the database.
 * @method static CSVConnection|void setException(mixed $value) Sets an exception from the database.
 * @method static CSVConnection|mixed getException($value = null) Retrieves an exception from the database.
 */
...
class CSVConnection implements IConnection
{
     ...
     */
    private function preConnect(): CSVConnection
    {
     ...
     * @return CSVConnection
     */
    private function postConnect(): CSVConnection
    {
    ...
    {
        try {
            $schemaFile = __DIR__ . '/CSV/Connection/CSV.json';
    ...
    /**
     * Connect to the CSV database (folder).
     *
     * @return CSVConnection
     * @throws Exceptions
     */
