...
/**
 * Criteria class for YAML QueryBuilder.
...
class Criteria implements ICriteria
{
    ...
    /**
     * Parse JOIN criteria (not supported for YAML, returns empty array).
     *
     * @param array $arguments The arguments.
     * @return array
     */
    ...
    /**
     * Parse ON criteria (not supported for YAML, returns empty array).
     *
     * @param array $arguments The arguments.
     * @return array
     */
