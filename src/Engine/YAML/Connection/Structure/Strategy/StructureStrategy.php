...
namespace GenericDatabase\Engine\YAML\Connection\Structure\Strategy;
 ...
 * work without calling private methods on YAMLConnection.
 * StructureHandler injects itself via setStructureHandler() after construction.
 *
 * @package GenericDatabase\Engine\YAML\Connection\Structure\Strategy
 */
