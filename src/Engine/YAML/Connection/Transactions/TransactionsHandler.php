...
namespace GenericDatabase\Engine\YAML\Connection\Transactions;
...
/**
 * Handles transaction operations for YAML connections.
 * Implements backup/restore mechanism for flat file transactions.
 *
 * @package GenericDatabase\Engine\YAML\Connection\Transactions
 */
class TransactionsHandler implements ITransactions
{
    ...
    /**
     * Begin a transaction.
     * For YAML files, this creates a backup of the current data.
     *
     * @return bool
     */
     ...
     * For YAML files, this saves the current data to file.
     *
     * @return bool
     */
     ...
     * For YAML files, this restores the backup data.
     *
     * @return bool
     */
