...
use GenericDatabase\Engine\MySQLi\QueryBuilder\Builder;
use GenericDatabase\Engine\MySQLi\QueryBuilder\Internal;

class MySQLiQueryBuilder implements IQueryBuilder
{
    use Query;
    use Singleton;
    ...
    {
        return MySQLiConnection::getInstance()->getAllMetadata();
    }
    ...
    private static function afterRun($instance): void
    {
        ...
        MySQLiConnection::getInstance()->query($query);
    }
    ...
    public function fetch(int $fetchStyle = null, mixed $fetchArgument = null, mixed $optArgs = null): mixed
    {
        ...
        return MySQLiConnection::getInstance()->fetch($fetchStyle, $fetchArgument, $optArgs);
    }
    ...
    public function fetchAll(int $fetchStyle = null, mixed $fetchArgument = null, mixed $optArgs = null): array|bool
    {
        ...
        return MySQLiConnection::getInstance()->fetchAll($fetchStyle, $fetchArgument, $optArgs);
    }
}
