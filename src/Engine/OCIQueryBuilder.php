...
use GenericDatabase\Engine\OCI\QueryBuilder\Query;
...
class OCIQueryBuilder implements IQueryBuilder
{
    ...
    {
        return OCIConnection::getInstance()->getAllMetadata();
    }
    ...
    private static function afterRun($instance): void
    {
        ...
        OCIConnection::getInstance()->query($query);
    }
    ...
    public function fetch(int $fetchStyle = null, mixed $fetchArgument = null, mixed $optArgs = null): mixed
    {
        ...
        return OCIConnection::getInstance()->fetch($fetchStyle, $fetchArgument, $optArgs);
    }
    ...
    public function fetchAll(int $fetchStyle = null, mixed $fetchArgument = null, mixed $optArgs = null): array|bool
    {
        ...
        return OCIConnection::getInstance()->fetchAll($fetchStyle, $fetchArgument, $optArgs);
    }
}
