...
namespace GenericDatabase\Engine\NEON\Connection\Statements;
...
/**
 * Handles SQL-like statement operations for NEON connections.
 * Extends AbstractFlatFileStatements to leverage common flat-file functionality.
 *
 * @package GenericDatabase\Engine\NEON\Connection\Statements
 */
