...
namespace GenericDatabase\Engine\NEON\Connection\Structure\Strategy;
 ...
 * work without calling private methods on NEONConnection.
 * StructureHandler injects itself via setStructureHandler() after construction.
 *
 * @package GenericDatabase\Engine\NEON\Connection\Structure\Strategy
 */
