...
namespace GenericDatabase\Engine\NEON\Connection;

use GenericDatabase\Helpers\Reflections;
use ReflectionException;

/**
 * NEON-specific constants and attribute management.
 *
 * @package GenericDatabase\Engine\NEON\Connection
 */
class NEON
{
    /**
     * NEON encoding option for block mode (multi-line output).
     */
    public const ATTR_NEON_BLOCK_MODE = 3001;
    ...
    /**
     * Get default NEON encoding flags (block mode for pretty output).
     *
     * @return int The encoding flags (0 = single line, 1 = block mode).
     */
    public static function getDefaultEncodingFlags(): int
    {
        return self::getAttribute(self::ATTR_NEON_BLOCK_MODE) === true
            || self::getAttribute(self::ATTR_PRETTY_PRINT) === true ? 1 : 0;
    }
}
