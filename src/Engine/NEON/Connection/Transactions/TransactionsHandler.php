...
namespace GenericDatabase\Engine\NEON\Connection\Transactions;
...
/**
 * Handles transaction operations for NEON connections.
 * Implements backup/restore mechanism for flat file transactions.
 *
 * @package GenericDatabase\Engine\NEON\Connection\Transactions
 */
class TransactionsHandler implements ITransactions
{
    ...
    /**
     * Begin a transaction.
     * For NEON files, this creates a backup of the current data.
     *
     * @return bool
     */
     ...
     * For NEON files, this saves the current data to file.
     *
     * @return bool
     */
     ...
     * For NEON files, this restores the backup data.
     *
     * @return bool
     */
