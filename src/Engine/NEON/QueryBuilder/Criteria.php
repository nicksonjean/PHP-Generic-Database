...
/**
 * Criteria class for NEON QueryBuilder.
...
class Criteria implements ICriteria
{
    ...
    /**
     * Parse JOIN criteria (not supported for NEON, returns empty array).
     *
     * @param array $arguments The arguments.
     * @return array
     */
    ...
    /**
     * Parse ON criteria (not supported for NEON, returns empty array).
     *
     * @param array $arguments The arguments.
     * @return array
     */
