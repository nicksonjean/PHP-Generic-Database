...
/**
 * Clause class for NEON QueryBuilder.
 * Handles building various SQL clauses for NEON data operations.
 *
...
class Clause implements IClause
{
    ...
    {
        $self = array_key_exists('self', $arguments) ? $arguments['self'] : new NEONQueryBuilder();
