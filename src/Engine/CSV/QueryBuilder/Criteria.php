...
/**
 * Criteria class for CSV QueryBuilder.
...
class Criteria implements ICriteria
{
    ...
    /**
     * Parse JOIN criteria (not supported for CSV, returns empty array).
     *
     * @param array $arguments The arguments.
     * @return array
     */
    ...
    /**
     * Parse ON criteria (not supported for CSV, returns empty array).
     *
     * @param array $arguments The arguments.
     * @return array
     */
