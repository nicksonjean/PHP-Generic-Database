...
class SQLiteEngine implements IConnection
{
    ...
    {
        $this->queryString = Translater::escape($params[0]);
        return $this->queryString;
    }
    ...
    public function fetch(int $fetchStyle = null, mixed $fetchArgument = null, mixed $optArgs = null): mixed
    {
        ...
        return match ($fetch) {
            SQLite::FETCH_OBJ,
            SQLite::FETCH_INTO,
            SQLite::FETCH_CLASS => Statements::internalFetchClassOrObject(self::$statement, $fetchArgument, $optArgs),
            SQLite::FETCH_COLUMN => Statements::internalFetchColumn(self::$statement, $fetchArgument),
            SQLite::FETCH_ASSOC => Statements::internalFetchAssoc(self::$statement),
            SQLite::FETCH_NUM => Statements::internalFetchNum(self::$statement),
            SQLite::FETCH_BOTH => Statements::internalFetchBoth(self::$statement),
    ...
    public function fetchAll(int $fetchStyle = null, mixed $fetchArgument = null, mixed $optArgs = null): mixed
    {
        ...
        return match ($fetch) {
            ...
            SQLite::FETCH_COLUMN => Statements::internalFetchAllColumn(self::$statement, $fetchArgument),
            SQLite::FETCH_ASSOC => Statements::internalFetchAllAssoc(self::$statement),
            SQLite::FETCH_NUM => Statements::internalFetchAllNum(self::$statement),
            SQLite::FETCH_BOTH => Statements::internalFetchAllBoth(self::$statement),
