...
class PgSQLEngine implements IConnection
{
    ...
    public function fetch(int $fetchStyle = null, mixed $fetchArgument = null, mixed $optArgs = null): mixed
    {
        ...
        return match ($fetch) {
            PgSQL::FETCH_OBJ,
            PgSQL::FETCH_INTO,
            PgSQL::FETCH_CLASS => Statements::internalFetchClassOrObject(self::$statement, $fetchArgument, $optArgs),
            PgSQL::FETCH_COLUMN => Statements::internalFetchColumn(self::$statement, $fetchArgument),
            PgSQL::FETCH_ASSOC => Statements::internalFetchAssoc(self::$statement),
            PgSQL::FETCH_NUM => Statements::internalFetchNum(self::$statement),
            PgSQL::FETCH_BOTH => Statements::internalFetchBoth(self::$statement),
    ...
    public function fetchAll(int $fetchStyle = null, mixed $fetchArgument = null, mixed $optArgs = null): mixed
    {
        ...
        return match ($fetch) {
            ...
            PgSQL::FETCH_COLUMN => Statements::internalFetchAllColumn(self::$statement, $fetchArgument),
            PgSQL::FETCH_ASSOC => Statements::internalFetchAllAssoc(self::$statement),
            PgSQL::FETCH_NUM => Statements::internalFetchAllNum(self::$statement),
            PgSQL::FETCH_BOTH => Statements::internalFetchAllBoth(self::$statement),
