...
/**
 * Criteria class for XML QueryBuilder.
...
class Criteria implements ICriteria
{
    ...
    /**
     * Parse JOIN criteria (not supported for XML, returns empty array).
     *
     * @param array $arguments The arguments.
     * @return array
     */
    ...
    /**
     * Parse ON criteria (not supported for XML, returns empty array).
     *
     * @param array $arguments The arguments.
     * @return array
     */
