...
/**
 * Clause class for XML QueryBuilder.
 * Handles building various SQL clauses for XML data operations.
 *
...
class Clause implements IClause
{
    ...
    {
        $self = array_key_exists('self', $arguments) ? $arguments['self'] : new XMLQueryBuilder();
