...
namespace GenericDatabase\Engine\XML\Connection\Transactions;
...
/**
 * Handles transaction operations for XML connections.
 * Implements backup/restore mechanism for flat file transactions.
 *
 * @package GenericDatabase\Engine\XML\Connection\Transactions
 */
class TransactionsHandler implements ITransactions
{
    ...
    /**
     * Begin a transaction.
     * For XML files, this creates a backup of the current data.
     *
     * @return bool
     */
     ...
     * For XML files, this saves the current data to file.
     *
     * @return bool
     */
     ...
     * For XML files, this restores the backup data.
     *
     * @return bool
     */
