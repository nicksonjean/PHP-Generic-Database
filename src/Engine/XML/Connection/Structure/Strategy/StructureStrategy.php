...
namespace GenericDatabase\Engine\XML\Connection\Structure\Strategy;
 ...
 * work without calling private methods on XMLConnection.
 * StructureHandler injects itself via setStructureHandler() after construction.
 *
 * @package GenericDatabase\Engine\XML\Connection\Structure\Strategy
 */
