...
namespace GenericDatabase\Engine\XML\Connection;

use GenericDatabase\Helpers\Reflections;
use ReflectionException;

/**
 * XML-specific constants and attribute management.
 *
 * @package GenericDatabase\Engine\XML\Connection
 */
class XML
{
    /**
    ...
    /**
     * Get default XML encoding flags (0 = compact, 1 = pretty).
     *
