...
use GenericDatabase\Engine\XML\Connection\DSN\DSNHandler;
use GenericDatabase\Engine\XML\Connection\Fetch\FetchHandler;
use GenericDatabase\Engine\XML\Connection\Report\ReportHandler;
use GenericDatabase\Engine\XML\Connection\Options\OptionsHandler;
use GenericDatabase\Engine\XML\Connection\Arguments\ArgumentsHandler;
use GenericDatabase\Engine\XML\Connection\Attributes\AttributesHandler;
use GenericDatabase\Engine\XML\Connection\Fetch\Strategy\FetchStrategy;
use GenericDatabase\Engine\XML\Connection\Statements\StatementsHandler;
use GenericDatabase\Engine\XML\Connection\Transactions\TransactionsHandler;
use GenericDatabase\Engine\XML\Connection\Arguments\Strategy\ArgumentsStrategy;
use GenericDatabase\Engine\XML\Connection\Structure\StructureHandler;
use GenericDatabase\Engine\XML\Connection\Structure\Strategy\StructureStrategy;

/**
 * XML Connection class for flat file database operations.
 * Provides SQL-like operations on XML files with Schema.ini support.
 *
 * @method static XMLConnection|void setDriver(mixed $value) Sets a driver from the database.
 * @method static XMLConnection|string getDriver($value = null) Retrieves a driver from the database.
 * @method static XMLConnection|void setHost(mixed $value) Sets a host from the database.
 * @method static XMLConnection|string getHost($value = null) Retrieves a host from the database.
 * @method static XMLConnection|void setPort(mixed $value) Sets a port from the database.
 * @method static XMLConnection|int getPort($value = null) Retrieves a port from the database.
 * @method static XMLConnection|void setUser(mixed $value) Sets a user from the database.
 * @method static XMLConnection|string getUser($value = null) Retrieves a user from the database.
 * @method static XMLConnection|void setPassword(mixed $value) Sets a password from the database.
 * @method static XMLConnection|string getPassword($value = null) Retrieves a password from the database.
 * @method static XMLConnection|void setDatabase(mixed $value) Sets a database name from the database.
 * @method static XMLConnection|string getDatabase($value = null) Retrieves a database name from the database.
 * @method static XMLConnection|void setOptions(mixed $value) Sets an options from the database.
 * @method static XMLConnection|array|null getOptions($value = null) Retrieves an options from the database.
 * @method static XMLConnection|void setStrcture(mixed $value) Sets an structure from the database.
 * @method static XMLConnection|array|null getStructure($value = null) Retrieves an structure from the database.*
 * @method static XMLConnection|static setConnected(mixed $value) Sets a connected status from the database.
 * @method static XMLConnection|mixed getConnected($value = null) Retrieves a connected status from the database.
 * @method static XMLConnection|void setDsn(mixed $value) Sets a dsn string from the database.
 * @method static XMLConnection|mixed getDsn($value = null) Retrieves a dsn string from the database.
 * @method static XMLConnection|void setAttributes(mixed $value) Sets an attributes from the database.
 * @method static XMLConnection|mixed getAttributes($value = null) Retrieves an attributes from the database.
 * @method static XMLConnection|void setCharset(mixed $value) Sets a charset from the database.
 * @method static XMLConnection|string getCharset($value = null) Retrieves a charset from the database.
 * @method static XMLConnection|void setException(mixed $value) Sets an exception from the database.
 * @method static XMLConnection|mixed getException($value = null) Retrieves an exception from the database.
 */
...
class XMLConnection implements IConnection
{
     ...
     */
    private function preConnect(): XMLConnection
    {
     ...
     * @return XMLConnection
     */
    private function postConnect(): XMLConnection
    {
    ...
    /**
     * This method is responsible for creating a new instance of the XML connection.
     *
     * @param string $database The path of the database directory or 'memory' for in-memory database
     * @return XMLConnection
     * @throws Exception
     */
    private function realConnect(string $database): XMLConnection
    {
        try {
            $schemaJson = __DIR__ . '/XML/Connection/XML.json';
    ...
    /**
     * Connect to the XML database (folder).
     *
     * @return XMLConnection
     * @throws Exceptions
     */
    public function connect(): XMLConnection
    {
        try {
    ...
    /**
     * Disconnect from the XML database.
     *
     * @return void
     */
