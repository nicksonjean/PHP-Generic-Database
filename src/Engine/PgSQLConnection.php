...
class PgSQLConnection implements IConnection
{
    ...
    public function lastInsertId(?string $name = null): string|int|false
    {
        ...
        if (isset($autoKeyRes['column_name'])) {
            ...
            return pg_last_oid($this->getStatement());
        }
    }
    ...
    {
        $queryString = Translater::binding(
    ...
    public function query(mixed ...$params): static|null
    {
        $this->setAllMetadata();
        if (!empty($params)) {
            $this->setStatement(pg_query($this->getConnection(), $this->parse(...$params)));
            $this->setQueryRows(pg_num_rows($this->getStatement()));
            $this->setQueryColumns(pg_num_fields($this->getStatement()));
            $this->setAffectedRows(pg_affected_rows($this->getStatement()));
        }
        return $this;
    }
    ...
    public function prepare(mixed ...$params): static|null
    {
        ...
        if (!empty($params)) {
            ...
            $this->setStatement(pg_prepare($this->getConnection(), $stmtName, $this->parse(...$params)));
    ...
    public function exec(mixed ...$params): bool|Result
    {
        ...
        $result = pg_execute($this->getConnection(), $stmtname, $param);
