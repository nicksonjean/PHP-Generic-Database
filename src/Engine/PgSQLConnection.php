 ...
 * @method static PgSQLConnection|void setOptions(mixed $value) Sets an options from the database.
 * @method static PgSQLConnection|array|null getOptions($value = null) Retrieves an options from the database.
 ...
 * @method static PgSQLConnection|void setAttributes(mixed $value) Sets an attributes from the database.
 * @method static PgSQLConnection|mixed getAttributes($value = null) Retrieves an attributes from the database.
 ...
 * @method static PgSQLConnection|void setException(mixed $value) Sets an exception from the database.
 * @method static PgSQLConnection|mixed getException($value = null) Retrieves an exception from the database.
 */
