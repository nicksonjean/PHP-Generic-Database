 ...
 * Uses StructureHandler for load/save (same architecture as NEONConnection).
 *
 * @method static NEONConnection|void setDatabase(mixed $value) Sets the database (directory) path.
 * @method static NEONConnection|string getDatabase($value = null) Retrieves the database path.
 */
...
class NEONConnection implements IConnection
{
    ...
    private static string $engine = 'neon';
