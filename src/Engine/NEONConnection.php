...
use GenericDatabase\Engine\NEON\Connection\Report\ReportHandler;
use GenericDatabase\Engine\NEON\Connection\Options\OptionsHandler;
use GenericDatabase\Engine\NEON\Connection\Arguments\ArgumentsHandler;
use GenericDatabase\Engine\NEON\Connection\Attributes\AttributesHandler;
use GenericDatabase\Engine\NEON\Connection\Fetch\Strategy\FetchStrategy;
use GenericDatabase\Engine\NEON\Connection\Statements\StatementsHandler;
use GenericDatabase\Engine\NEON\Connection\Transactions\TransactionsHandler;
use GenericDatabase\Engine\NEON\Connection\Arguments\Strategy\ArgumentsStrategy;
use GenericDatabase\Engine\NEON\Connection\Structure\StructureHandler;
use GenericDatabase\Engine\NEON\Connection\Structure\Strategy\StructureStrategy;

/**
 * NEON Connection class for flat file database operations.
 * Provides SQL-like operations on NEON files with Schema.ini support.
 *
 * @method static NEONConnection|void setDriver(mixed $value) Sets a driver from the database.
 * @method static NEONConnection|string getDriver($value = null) Retrieves a driver from the database.
 * @method static NEONConnection|void setHost(mixed $value) Sets a host from the database.
 * @method static NEONConnection|string getHost($value = null) Retrieves a host from the database.
 * @method static NEONConnection|void setPort(mixed $value) Sets a port from the database.
 * @method static NEONConnection|int getPort($value = null) Retrieves a port from the database.
 * @method static NEONConnection|void setUser(mixed $value) Sets a user from the database.
 * @method static NEONConnection|string getUser($value = null) Retrieves a user from the database.
 * @method static NEONConnection|void setPassword(mixed $value) Sets a password from the database.
 * @method static NEONConnection|string getPassword($value = null) Retrieves a password from the database.
 * @method static NEONConnection|void setDatabase(mixed $value) Sets a database name from the database.
 * @method static NEONConnection|string getDatabase($value = null) Retrieves a database name from the database.
 * @method static NEONConnection|void setOptions(mixed $value) Sets an options from the database.
 * @method static NEONConnection|array|null getOptions($value = null) Retrieves an options from the database.
 * @method static NEONConnection|void setStrcture(mixed $value) Sets an structure from the database.
 * @method static NEONConnection|array|null getStructure($value = null) Retrieves an structure from the database.*
 * @method static NEONConnection|static setConnected(mixed $value) Sets a connected status from the database.
 * @method static NEONConnection|mixed getConnected($value = null) Retrieves a connected status from the database.
 * @method static NEONConnection|void setDsn(mixed $value) Sets a dsn string from the database.
 * @method static NEONConnection|mixed getDsn($value = null) Retrieves a dsn string from the database.
 * @method static NEONConnection|void setAttributes(mixed $value) Sets an attributes from the database.
 * @method static NEONConnection|mixed getAttributes($value = null) Retrieves an attributes from the database.
 * @method static NEONConnection|void setCharset(mixed $value) Sets a charset from the database.
 * @method static NEONConnection|string getCharset($value = null) Retrieves a charset from the database.
 * @method static NEONConnection|void setException(mixed $value) Sets an exception from the database.
 * @method static NEONConnection|mixed getException($value = null) Retrieves an exception from the database.
 */
#[AllowDynamicProperties]
class NEONConnection implements IConnection
{
    use Methods;
    use Singleton;
     ...
     */
    private function preConnect(): NEONConnection
    {
     ...
     * @return NEONConnection
     */
    private function postConnect(): NEONConnection
    {
    ...
    /**
     * This method is responsible for creating a new instance of the NEON connection.
     *
     * @param string $database The path of the database directory or 'memory' for in-memory database
     * @return NEONConnection
     * @throws Exception
     */
    private function realConnect(string $database): NEONConnection
    {
        try {
            $schemaJson = __DIR__ . '/NEON/Connection/NEON.json';
    ...
    /**
     * Connect to the NEON database (folder).
     *
     * @return NEONConnection
     * @throws Exceptions
     */
    public function connect(): NEONConnection
    {
        try {
