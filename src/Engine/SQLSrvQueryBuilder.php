...
class SQLSrvQueryBuilder implements IQueryBuilder
{
    ...
    {
        return SQLSrvConnection::getInstance()->getAllMetadata();
    }
    ...
    private static function afterRun($instance): void
    {
        ...
        SQLSrvConnection::getInstance()->query($query);
    }
    ...
    public function fetch(int $fetchStyle = null, mixed $fetchArgument = null, mixed $optArgs = null): mixed
    {
        ...
        return SQLSrvConnection::getInstance()->fetch($fetchStyle, $fetchArgument, $optArgs);
    }
    ...
    public function fetchAll(int $fetchStyle = null, mixed $fetchArgument = null, mixed $optArgs = null): array|bool
    {
        ...
        return SQLSrvConnection::getInstance()->fetchAll($fetchStyle, $fetchArgument, $optArgs);
    }
}
