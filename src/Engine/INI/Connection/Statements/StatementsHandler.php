...
namespace GenericDatabase\Engine\INI\Connection\Statements;
...
/**
 * Handles SQL-like statement operations for INI connections.
 * Extends AbstractFlatFileStatements to leverage common flat-file functionality.
 *
 * @package GenericDatabase\Engine\INI\Connection\Statements
 */
