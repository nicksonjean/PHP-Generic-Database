...
namespace GenericDatabase\Engine\INI\Connection\Transactions;
...
/**
 * Handles transaction operations for INI connections.
 * Implements backup/restore mechanism for flat file transactions.
 *
 * @package GenericDatabase\Engine\INI\Connection\Transactions
 */
class TransactionsHandler implements ITransactions
{
    ...
    /**
     * Begin a transaction.
     * For INI files, this creates a backup of the current data.
     *
     * @return bool
     */
     ...
     * For INI files, this saves the current data to file.
     *
     * @return bool
     */
     ...
     * For INI files, this restores the backup data.
     *
     * @return bool
     */
