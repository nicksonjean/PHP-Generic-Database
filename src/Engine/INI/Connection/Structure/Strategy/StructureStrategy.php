...
namespace GenericDatabase\Engine\INI\Connection\Structure\Strategy;
 ...
 * work without calling private methods on INIConnection.
 * StructureHandler injects itself via setStructureHandler() after construction.
 *
 * @package GenericDatabase\Engine\INI\Connection\Structure\Strategy
 */
