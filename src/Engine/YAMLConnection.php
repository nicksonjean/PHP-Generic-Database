...
use GenericDatabase\Engine\YAML\Connection\DSN\DSNHandler;
use GenericDatabase\Engine\YAML\Connection\Fetch\FetchHandler;
...
use GenericDatabase\Engine\YAML\Connection\Arguments\ArgumentsHandler;
use GenericDatabase\Engine\YAML\Connection\Attributes\AttributesHandler;
use GenericDatabase\Engine\YAML\Connection\Fetch\Strategy\FetchStrategy;
use GenericDatabase\Engine\YAML\Connection\Statements\StatementsHandler;
use GenericDatabase\Engine\YAML\Connection\Transactions\TransactionsHandler;
use GenericDatabase\Engine\YAML\Connection\Arguments\Strategy\ArgumentsStrategy;
use GenericDatabase\Engine\YAML\Connection\Structure\StructureHandler;
use GenericDatabase\Engine\YAML\Connection\Structure\Strategy\StructureStrategy;
 ...
 *
 * @method static YAMLConnection|void setDriver(mixed $value) Sets a driver from the database.
 * @method static YAMLConnection|string getDriver($value = null) Retrieves a driver from the database.
 * @method static YAMLConnection|void setHost(mixed $value) Sets a host from the database.
 * @method static YAMLConnection|string getHost($value = null) Retrieves a host from the database.
 * @method static YAMLConnection|void setPort(mixed $value) Sets a port from the database.
 * @method static YAMLConnection|int getPort($value = null) Retrieves a port from the database.
 * @method static YAMLConnection|void setUser(mixed $value) Sets a user from the database.
 * @method static YAMLConnection|string getUser($value = null) Retrieves a user from the database.
 * @method static YAMLConnection|void setPassword(mixed $value) Sets a password from the database.
 * @method static YAMLConnection|string getPassword($value = null) Retrieves a password from the database.
 * @method static YAMLConnection|void setDatabase(mixed $value) Sets a database name from the database.
 * @method static YAMLConnection|string getDatabase($value = null) Retrieves a database name from the database.
 * @method static YAMLConnection|void setOptions(mixed $value) Sets an options from the database.
 * @method static YAMLConnection|array|null getOptions($value = null) Retrieves an options from the database.
 * @method static YAMLConnection|void setStrcture(mixed $value) Sets an structure from the database.
 * @method static YAMLConnection|array|null getStructure($value = null) Retrieves an structure from the database.*
 * @method static YAMLConnection|static setConnected(mixed $value) Sets a connected status from the database.
 * @method static YAMLConnection|mixed getConnected($value = null) Retrieves a connected status from the database.
 * @method static YAMLConnection|void setDsn(mixed $value) Sets a dsn string from the database.
 * @method static YAMLConnection|mixed getDsn($value = null) Retrieves a dsn string from the database.
 * @method static YAMLConnection|void setAttributes(mixed $value) Sets an attributes from the database.
 * @method static YAMLConnection|mixed getAttributes($value = null) Retrieves an attributes from the database.
 * @method static YAMLConnection|void setCharset(mixed $value) Sets a charset from the database.
 * @method static YAMLConnection|string getCharset($value = null) Retrieves a charset from the database.
 * @method static YAMLConnection|void setException(mixed $value) Sets an exception from the database.
 * @method static YAMLConnection|mixed getException($value = null) Retrieves an exception from the database.
 */
...
class YAMLConnection implements IConnection
{
     ...
     */
    private function preConnect(): YAMLConnection
    {
     ...
     * @return YAMLConnection
     */
    private function postConnect(): YAMLConnection
    {
    ...
    {
        try {
            $schemaJson = __DIR__ . '/YAML/Connection/YAML.json';
    ...
    /**
     * Connect to the YAML database (folder).
     *
     * @return YAMLConnection
     * @throws Exceptions
     */
    ...
    /**
     * Disconnect from the YAML database.
     *
     * @return void
     */
