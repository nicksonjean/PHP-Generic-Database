...
class Compare
{
    ...
    private static function getObjectConnectionType(object $cnx): string
    {
        ...
        return match (true) {
            ...
            is_a($cnx, $its(An::NAT_PGSQL)) && $cnx::class === $its(An::NAT_PGSQL) => 'pgsql',
            is_a($cnx, 'PDO') && $cnx::class === 'PDO' && $attr($cnx) === $its(An::PDO_MYSQL) => 'PDO mysql',
            is_a($cnx, 'PDO') && $cnx::class === 'PDO' && $attr($cnx) === $its(An::PDO_PGSQL) => 'PDO pgsql',
            ...
            is_a($cnx, 'PDO') && $cnx::class === 'PDO' && $attr($cnx) === $its(An::PDO_DBLIB) => 'PDO dblib',
            is_a($cnx, 'PDO') && $cnx::class === 'PDO' && $attr($cnx) === $its(An::PDO_ODBC) => 'PDO odbc',
