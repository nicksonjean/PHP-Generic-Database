...
// $b = $context->prepare('UPDATE estado SET nome = :nome, sigla = :sigla WHERE id = :id', 'PDC', 'TI', 143);
// $b = $context->prepare('DELETE FROM estado WHERE id IN (:id)', [[':id' => '141'], [':id' => '142'], [':id' => '143']]);
