...
// $b = $context->prepare('UPDATE estado SET nome = :nome WHERE id = :id', [':nome' => 'TE', ':id' => '123']);
// $b = $context->prepare('UPDATE estado SET nome = :nome, sigla = :sigla WHERE id = :id', 'PDC', 'TI', 123);
// $b = $context->prepare('DELETE FROM estado WHERE id IN (:id)', [[':id' => '123'], [':id' => '124'], [':id' => '125']]);
