...
class Autoloader
{
     ...
     * $result = Autoloader::renderFile($file, $vars);
     * print_r($result);
     * // Output: <div>Hello John, you are 30 years old</div>
     */
     ...
     *     'vars' => ['name' => 'John', 'age' => 30],
     * ];
     * Autoloader::loadFromArray($config);
     */
     ...
     * Autoloader::loadFromJson($jsonFilePath);
     */
     ...
     * $file = 'path/to/file.php';
     * $vars = ['name' => 'John', 'age' => 30];
     * Autoloader::includeFileWithVars($file, $vars);
     */
     ...
     *
     * @example
     * $uniqueKey = 'path/to/file.php';
     * $result = Autoloader::getLoadedVariables($uniqueKey);
     * print_r($result);
