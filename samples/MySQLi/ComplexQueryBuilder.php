...
$qb1 = (new MySQLiQueryBuilder($context))
...
$qb2 = (new MySQLiQueryBuilder($context))
...
$qb3 = (new MySQLiQueryBuilder($context))
...
$qb4 = (new MySQLiQueryBuilder($context))
...
$qb5 = MySQLiQueryBuilder::with($context)::distinct('estado_id')
    ->from('cidade')
    ->order('estado_id ASC')
    ->limit('0, 10');
...
$qb6 = (new MySQLiQueryBuilder($context))
