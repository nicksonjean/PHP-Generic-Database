...
$qb1 = (new INIQueryBuilder($context))
...
$qb2 = (new INIQueryBuilder($context))
...
$qb3 = (new INIQueryBuilder($context))
...
$qb4 = (new INIQueryBuilder($context))
...
$qb5 = INIQueryBuilder::with($context)::distinct('estado_id')
    ->from('cidade')
    ->order('estado_id ASC')
    ->limit('0, 10');
...
$qb6 = (new INIQueryBuilder($context))
