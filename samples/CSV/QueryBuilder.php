...
$test0 = (new CSVQueryBuilder($context))->select(['e.id AS Codigo', 'e.nome AS Estado', 'e.sigla AS Sigla'])
    ->from(['estado e'])
    ->where(['e.id >= 25']);
...
$testA = CSVQueryBuilder::with($context)::select(['e.id AS Codigo', 'e.nome AS Estado', 'e.sigla AS Sigla'])
    ->from(['estado e'])
    ->where(['e.id <= 25']);
...
$testB = (new CSVQueryBuilder($context))->select('e.id AS Codigo, e.nome AS Estado, e.sigla AS Sigla')
    ->from('estado e')
    ->where('e.id >= 1')
    ->andWhere('e.id <= 5');
...
$testC = CSVQueryBuilder::with($context)::select(['e.id AS Codigo', 'e.nome AS Estado', 'e.sigla AS Sigla'])
    ->from('estado e')
    ->where('e.id = 6')
    ->orWhere('e.id = 11');
...
$testD = CSVQueryBuilder::with($context)::select(['e.id AS Codigo', 'e.nome AS Estado', 'e.sigla AS Sigla'])
    ->from('estado e')
...
$testE = CSVQueryBuilder::with($context)::select(['e.id AS Codigo', 'e.nome AS Estado', 'e.sigla AS Sigla'])
    ->from('estado e')
...
$testF = CSVQueryBuilder::with($context)::select(['e.id AS Codigo', 'e.nome AS Estado', 'e.sigla AS Sigla'])
    ->from('estado e')
...
$testF1 = CSVQueryBuilder::with($context)::select(['e.id AS Codigo', 'e.nome AS Estado', 'e.sigla AS Sigla'])
    ->from('estado e')
...
$testG = CSVQueryBuilder::with($context)::select(['e.id AS Codigo', 'e.nome AS Estado', 'e.sigla AS Sigla'])
    ->from('estado e')
...
$testH1 = CSVQueryBuilder::with($context)::select(['e.id AS Codigo', 'e.nome AS Estado', 'COUNT(c.id) as num_cidades'])
    ->from(['estado e'])
    ->join(['cidade c'])
    ->on(['e.id = c.estado_id'])
    ->group(['e.id, e.nome'])
...
$testH2 = CSVQueryBuilder::with($context)::select('e.id AS Codigo, e.nome AS Estado, COUNT(c.id) as num_cidades')
    ->from('estado e')
    ->join('cidade c')
    ->on('e.id = c.estado_id')
    ->group('e.id, e.nome')
...
$testI = CSVQueryBuilder::with($context)::select(['e.*', 'c.*'])
...
$testI1 = CSVQueryBuilder::with($context)::select('e.*, c.*')
    ->from('estado e, cidade c')
    ->where('e.id = 5')
    ->andWhere('c.id = 5');
...
$testJ = CSVQueryBuilder::with($context)::select(['e.*', 'c.*'])
    ->from(['estado e', 'cidade c'])
...
$testJ1 = CSVQueryBuilder::with($context)::select(['e.*', 'c.*'])
    ->from(['estado e', 'cidade c'])
...
$testJ2 = CSVQueryBuilder::with($context)::select('e.*, c.*')
    ->from('estado e, cidade c')
    ->where([['e.id = 10'], ['AND' => 'e.id = 11'], ['AND' => 'e.id = 12']])
    ->andWhere([['e.id = 13'], ['OR' => 'c.id = 14']])
    ->order(['c.id DESC'])
...
// $combinedQuery = CSVQueryBuilder::with($context)::select(['e.id', 'e.nome'])
//     ->from('estado AS e')
//     ->where('e.id', '=', '10')
//     ->union(
//         CSVQueryBuilder::with($context)::select(['c.id', 'c.nome'])
//             ->from('estado AS c')
//             ->where('c.id', '=', 'e.id')
//     )
//     ->union(
//         CSVQueryBuilder::with($context)::select(['d.id', 'd.nome'])
//             ->from('estado AS d')
//             ->where('d.id', '=', 'e.id')
//     );
...
// $query = CSVQueryBuilder::with($context)::select(['*'])
//     ->from('orders AS o')
//     ->where('o.status', '=', 'completed')
//     ->where('o.total_amount', '>', 1000)
//     ->andWhere(
//         CSVQueryBuilder::with($context)::exists(
//             CSVQueryBuilder::with($context)::select(['1'])
//                 ->from('customers c')
//                 ->where('c.id', '=', 'o.customer_id')
//         )
//     )
//     ->orWhere(
//         CSVQueryBuilder::with($context)::notExists(
//             CSVQueryBuilder::with($context)::select(['1'])
//                 ->from('returns r')
...
// var_dump(CSVQueryBuilder::with($context)::getRegexSelect());
// var_dump(CSVQueryBuilder::with($context)::getRegexFrom());
// var_dump(CSVQueryBuilder::with($context)::getRegexOn());
// var_dump(CSVQueryBuilder::with($context)::getRegexGroupOrder());
// var_dump(CSVQueryBuilder::with($context)::getRegexWhereHaving());
