...
$qb1 = (new CSVQueryBuilder($context))
...
$qb2 = (new CSVQueryBuilder($context))
...
$qb3 = (new CSVQueryBuilder($context))
...
$qb4 = (new CSVQueryBuilder($context))
...
$qb5 = CSVQueryBuilder::with($context)::distinct('estado_id')
    ->from('cidade')
    ->order('estado_id ASC')
    ->limit('0, 10');
...
$qb6 = (new CSVQueryBuilder($context))
