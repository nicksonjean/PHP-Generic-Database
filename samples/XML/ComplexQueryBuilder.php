...
$qb1 = (new XMLQueryBuilder($context))
...
$qb2 = (new XMLQueryBuilder($context))
...
$qb3 = (new XMLQueryBuilder($context))
...
$qb4 = (new XMLQueryBuilder($context))
...
$qb5 = XMLQueryBuilder::with($context)::distinct('estado_id')
    ->from('cidade')
    ->order('estado_id ASC')
    ->limit('0, 10');
...
$qb6 = (new XMLQueryBuilder($context))
