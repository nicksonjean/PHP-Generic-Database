 ...
 * Fontes: estado, cidade (estado.xml, cidade.xml)
 */
...
$qbUnion = (new XMLQueryBuilder($context))
    ...
    ->from('estado')
    ->union(
        (new XMLQueryBuilder($context))->select('nome')->from('cidade')
    )
    ->order('nome ASC')
    ->limit('0, 10');
...
$qbUnion2 = (new XMLQueryBuilder($context))
    ->select('nome')
    ->from('estado')
...
$qbUnionAll = (new XMLQueryBuilder($context))
    ...
    ->from('estado')
    ->unionAll(
        (new XMLQueryBuilder($context))->select('id', 'nome')->from('cidade')
    )
    ->order('nome ASC')
    ->limit('0, 8');
...
$qbExists2 = (new XMLQueryBuilder($context))
    ->select('e.id', 'e.nome', 'e.sigla')
    ->from('estado e')
    ->whereExists(
        (new XMLQueryBuilder($context))
...
$qbComplex = (new XMLQueryBuilder($context))
...
$qbUnionAllTest13 = (new XMLQueryBuilder($context))
    ->select('id', 'nome')
    ->from('estado')
    ->unionAll(
        (new XMLQueryBuilder($context))->select('id', 'nome')->from('cidade')
