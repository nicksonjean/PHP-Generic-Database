...
$test0 = (new SQLiteQueryBuilder())->select(['e.id AS Codigo', 'e.nome AS Estado', 'e.sigla AS Sigla'])
    ->from(['estado e'])
    ->where(['e.id >= 25']);
...
$testA = SQLiteQueryBuilder::select(['e.id AS Codigo', 'e.nome AS Estado', 'e.sigla AS Sigla'])
    ->from(['estado e'])
    ->where(['e.id <= 25']);
...
$testB = (new SQLiteQueryBuilder())->select('e.id AS Codigo, e.nome AS Estado, e.sigla AS Sigla')
    ->from('estado e')
    ->where('e.id >= 1')
    ->andWhere('e.id <= 5');
...
$testC = SQLiteQueryBuilder::select(['e.id AS Codigo', 'e.nome AS Estado', 'e.sigla AS Sigla'])
    ->from('estado e')
    ->where('e.id = 6')
    ->orWhere('e.id = 11');
...
$testD = SQLiteQueryBuilder::select(['e.id AS Codigo', 'e.nome AS Estado', 'e.sigla AS Sigla'])
    ->from('estado e')
...
$testE = SQLiteQueryBuilder::select(['e.id AS Codigo', 'e.nome AS Estado', 'e.sigla AS Sigla'])
    ->from('estado e')
...
$testF = SQLiteQueryBuilder::select(['e.id AS Codigo', 'e.nome AS Estado', 'e.sigla AS Sigla'])
    ->from('estado e')
...
$testF1 = SQLiteQueryBuilder::select(['e.id AS Codigo', 'e.nome AS Estado', 'e.sigla AS Sigla'])
    ->from('estado e')
...
$testG = SQLiteQueryBuilder::select(['e.id AS Codigo', 'e.nome AS Estado', 'e.sigla AS Sigla'])
    ->from('estado e')
...
$testH1 = SQLiteQueryBuilder::select(['e.id AS Codigo', 'e.nome AS Estado', 'COUNT(c.id) as num_cidades'])
    ->from(['estado e'])
    ->join(['cidade c'])
    ->on(['e.id = c.estado_id'])
    ->group(['e.id, e.nome'])
...
$testH2 = SQLiteQueryBuilder::select('e.id AS Codigo, e.nome AS Estado, COUNT(c.id) as num_cidades')
    ->from('estado e')
    ->join('cidade c')
    ->on('e.id = c.estado_id')
    ->group('e.id, e.nome')
...
$testI = SQLiteQueryBuilder::select(['e.*', 'c.*'])
...
$testI1 = SQLiteQueryBuilder::select('e.*, c.*')
    ->from('estado e, cidade c')
    ->where('e.id = 5')
    ->andWhere('c.id = 5');
...
$testJ = SQLiteQueryBuilder::select(['e.*', 'c.*'])
    ->from(['estado e', 'cidade c'])
...
$testJ1 = SQLiteQueryBuilder::select(['e.*', 'c.*'])
    ->from(['estado e', 'cidade c'])
...
$testJ2 = SQLiteQueryBuilder::select('e.*, c.*')
    ->from('estado e, cidade c')
    ->where([['e.id = 10'], ['AND' => 'e.id = 11'], ['AND' => 'e.id = 12']])
    ->andWhere([['e.id = 13'], ['OR' => 'c.id = 14']])
    ->order(['c.id DESC'])
...
// $combinedQuery = SQLiteQueryBuilder::select(['maconha.id', 'maconha.nome'])
//     ->from('estado AS maconha')
//     ->where('maconha.id', '=', 'teste')
//     ->union(
//         SQLiteQueryBuilder::select(['c.id', 'c.nome'])
//             ->from('estado AS c')
//             ->where('c.id', '=', 'maconha.id')
//     )
//     ->union(
//         SQLiteQueryBuilder::select(['d.id', 'd.nome'])
//             ->from('estado AS d')
...
// $query = SQLiteQueryBuilder::select(['*'])
//     ->from('orders AS o')
//     ->where('o.status', '=', 'completed')
//     ->where('o.total_amount', '>', 1000)
//     ->andWhere(
//         SQLiteQueryBuilder::exists(
//             SQLiteQueryBuilder::select(['1'])
//                 ->from('customers c')
//                 ->where('c.id', '=', 'o.customer_id')
//         )
//     )
//     ->orWhere(
//         SQLiteQueryBuilder::notExists(
//             SQLiteQueryBuilder::select(['1'])
//                 ->from('returns r')
...
// var_dump(SQLiteQueryBuilder::getRegexSelect());
// var_dump(SQLiteQueryBuilder::getRegexFrom());
// var_dump(SQLiteQueryBuilder::getRegexOn());
// var_dump(SQLiteQueryBuilder::getRegexGroupOrder());
// var_dump(SQLiteQueryBuilder::getRegexWhereHaving());
