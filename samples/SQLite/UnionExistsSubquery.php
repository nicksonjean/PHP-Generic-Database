...
$qbUnion = (new SQLiteQueryBuilder($context))
    ->select('nome')
    ->from('estado')
    ->union(
        (new SQLiteQueryBuilder($context))->select('nome')->from('cidade')
    )
    ->order('nome ASC')
    ->limit('0, 10');
...
$qbUnion2 = (new SQLiteQueryBuilder($context))
    ->select('nome')
    ->from('estado')
    ->union((new SQLiteQueryBuilder($context))->select('nome')->from('cidade'))
    ->order('nome ASC')
    ->limit('0, 5');
...
$qbUnionAll = (new SQLiteQueryBuilder($context))
    ->select('id', 'nome')
    ->from('estado')
    ->unionAll(
        (new SQLiteQueryBuilder($context))->select('id', 'nome')->from('cidade')
    )
    ->order('nome ASC')
    ->limit('0, 8');
...
$qbExists = (new SQLiteQueryBuilder($context))
    ->select('e.id', 'e.nome', 'e.sigla')
    ->from('estado e')
    ->whereExists(
        (new SQLiteQueryBuilder($context))
            ->select('1')
            ->from('cidade c')
...
$qbExists2 = (new SQLiteQueryBuilder($context))
    ->select('e.id', 'e.nome', 'e.sigla')
    ->from('estado e')
    ->whereExists(
        (new SQLiteQueryBuilder($context))
...
$qbNotExists = (new SQLiteQueryBuilder($context))
    ->select('e.id', 'e.nome', 'e.sigla')
    ->from('estado e')
    ->whereNotExists(
        (new SQLiteQueryBuilder($context))
...
$qbComplex = (new SQLiteQueryBuilder($context))
...
$qbUnionAllTest13 = (new SQLiteQueryBuilder($context))
    ->select('id', 'nome')
    ->from('estado')
    ->unionAll(
        (new SQLiteQueryBuilder($context))->select('id', 'nome')->from('cidade')
