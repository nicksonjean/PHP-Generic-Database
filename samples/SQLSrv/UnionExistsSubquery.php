...
$sqlUnion = 'SELECT nome FROM (SELECT nome FROM estado UNION SELECT nome FROM cidade) AS resultado ORDER BY nome OFFSET 0 ROWS FETCH NEXT 15 ROWS ONLY';
...
$sqlUnionAll = 'SELECT nome FROM (SELECT nome FROM estado UNION SELECT nome FROM cidade) AS resultado ORDER BY nome OFFSET 0 ROWS FETCH NEXT 10 ROWS ONLY';
