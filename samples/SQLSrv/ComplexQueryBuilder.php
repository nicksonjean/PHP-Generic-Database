...
$qb1 = (new SQLSrvQueryBuilder($context))
...
$qb2 = (new SQLSrvQueryBuilder($context))
...
$qb3 = (new SQLSrvQueryBuilder($context))
...
$qb4 = (new SQLSrvQueryBuilder($context))
...
$qb5 = SQLSrvQueryBuilder::with($context)::distinct('estado_id')
    ->from('cidade')
    ->order('estado_id ASC')
    ->limit('0, 10');
...
$qb6 = (new SQLSrvQueryBuilder($context))
