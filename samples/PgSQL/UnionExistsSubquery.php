...
$qbUnion = (new PgSQLQueryBuilder($context))
    ->select('nome')
    ->from('estado')
    ->union(
        (new PgSQLQueryBuilder($context))->select('nome')->from('cidade')
    )
    ->order('nome ASC')
    ->limit('0, 10');
...
$qbUnion2 = (new PgSQLQueryBuilder($context))
    ->select('nome')
    ->from('estado')
    ->union((new PgSQLQueryBuilder($context))->select('nome')->from('cidade'))
    ->order('nome ASC')
    ->limit('0, 5');
...
$qbUnionAll = (new PgSQLQueryBuilder($context))
    ->select('id', 'nome')
    ->from('estado')
    ->unionAll(
        (new PgSQLQueryBuilder($context))->select('id', 'nome')->from('cidade')
    )
    ->order('nome ASC')
    ->limit('0, 8');
...
$qbExists = (new PgSQLQueryBuilder($context))
    ->select('e.id', 'e.nome', 'e.sigla')
    ->from('estado e')
    ->whereExists(
        (new PgSQLQueryBuilder($context))
            ->select('1')
            ->from('cidade c')
...
$qbExists2 = (new PgSQLQueryBuilder($context))
    ->select('e.id', 'e.nome', 'e.sigla')
    ->from('estado e')
    ->whereExists(
        (new PgSQLQueryBuilder($context))
...
$qbNotExists = (new PgSQLQueryBuilder($context))
    ->select('e.id', 'e.nome', 'e.sigla')
    ->from('estado e')
    ->whereNotExists(
        (new PgSQLQueryBuilder($context))
...
$qbComplex = (new PgSQLQueryBuilder($context))
...
$qbUnionAllTest13 = (new PgSQLQueryBuilder($context))
    ->select('id', 'nome')
    ->from('estado')
    ->unionAll(
        (new PgSQLQueryBuilder($context))->select('id', 'nome')->from('cidade')
