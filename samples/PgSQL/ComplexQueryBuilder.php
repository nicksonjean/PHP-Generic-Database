...
$qb1 = (new PgSQLQueryBuilder($context))
...
$qb2 = (new PgSQLQueryBuilder($context))
...
$qb3 = (new PgSQLQueryBuilder($context))
...
$qb4 = (new PgSQLQueryBuilder($context))
...
$qb5 = PgSQLQueryBuilder::with($context)::distinct('estado_id')
    ->from('cidade')
    ->order('estado_id ASC')
    ->limit('0, 10');
...
$qb6 = (new PgSQLQueryBuilder($context))
