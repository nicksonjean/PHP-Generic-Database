...
$qb1 = (new YAMLQueryBuilder($context))
...
$qb2 = (new YAMLQueryBuilder($context))
...
$qb3 = (new YAMLQueryBuilder($context))
...
$qb4 = (new YAMLQueryBuilder($context))
...
$qb5 = YAMLQueryBuilder::with($context)::distinct('estado_id')
    ->from('cidade')
    ->order('estado_id ASC')
    ->limit('0, 10');
...
$qb6 = (new YAMLQueryBuilder($context))
