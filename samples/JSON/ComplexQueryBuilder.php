...
$qb1 = (new JSONQueryBuilder($context))
...
$qb2 = (new JSONQueryBuilder($context))
...
$qb3 = (new JSONQueryBuilder($context))
...
$qb4 = (new JSONQueryBuilder($context))
...
$qb5 = JSONQueryBuilder::with($context)::distinct('estado_id')
    ->from('cidade')
    ->order('estado_id ASC')
    ->limit('0, 10');
...
$qb6 = (new JSONQueryBuilder($context))
