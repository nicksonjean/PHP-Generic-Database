...
$qbUnion = (new JSONQueryBuilder($context))
    ...
    ->from('estado')
    ->union(
        (new JSONQueryBuilder($context))->select('nome')->from('cidade')
    )
    ->order('nome ASC')
    ->limit('0, 10');
...
$qbUnionAll = (new JSONQueryBuilder($context))
    ...
    ->from('estado')
    ->unionAll(
        (new JSONQueryBuilder($context))->select('id', 'nome')->from('cidade')
    )
    ->order('nome ASC')
    ->limit('0, 8');
...
$qbComplex = (new JSONQueryBuilder($context))
...
$qbUnionAllTest13 = (new JSONQueryBuilder($context))
    ->select('id', 'nome')
    ->from('estado')
    ->unionAll(
        (new JSONQueryBuilder($context))->select('id', 'nome')->from('cidade')
