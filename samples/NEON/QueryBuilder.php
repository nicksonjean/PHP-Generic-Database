...
$test0 = (new NEONQueryBuilder($context))->select(['e.id AS Codigo', 'e.nome AS Estado', 'e.sigla AS Sigla'])
    ->from(['estado e'])
    ->where(['e.id >= 25']);
...
$testA = NEONQueryBuilder::with($context)::select(['e.id AS Codigo', 'e.nome AS Estado', 'e.sigla AS Sigla'])
    ->from(['estado e'])
    ->where(['e.id <= 25']);
...
$testB = (new NEONQueryBuilder($context))->select('e.id AS Codigo, e.nome AS Estado, e.sigla AS Sigla')
    ->from('estado e')
    ->where('e.id >= 1')
    ->andWhere('e.id <= 5');
...
$testC = NEONQueryBuilder::with($context)::select(['e.id AS Codigo', 'e.nome AS Estado', 'e.sigla AS Sigla'])
    ->from('estado e')
    ->where('e.id = 6')
    ->orWhere('e.id = 11');
...
$testD = NEONQueryBuilder::with($context)::select(['e.id AS Codigo', 'e.nome AS Estado', 'e.sigla AS Sigla'])
    ->from('estado e')
...
$testE = NEONQueryBuilder::with($context)::select(['e.id AS Codigo', 'e.nome AS Estado', 'e.sigla AS Sigla'])
    ->from('estado e')
...
$testF = NEONQueryBuilder::with($context)::select(['e.id AS Codigo', 'e.nome AS Estado', 'e.sigla AS Sigla'])
    ->from('estado e')
...
$testF1 = NEONQueryBuilder::with($context)::select(['e.id AS Codigo', 'e.nome AS Estado', 'e.sigla AS Sigla'])
    ->from('estado e')
...
$testG = NEONQueryBuilder::with($context)::select(['e.id AS Codigo', 'e.nome AS Estado', 'e.sigla AS Sigla'])
    ->from('estado e')
...
$testH1 = NEONQueryBuilder::with($context)::select(['e.id AS Codigo', 'e.nome AS Estado', 'COUNT(c.id) as num_cidades'])
    ->from(['estado e'])
    ->join(['cidade c'])
    ->on(['e.id = c.estado_id'])
    ->group(['e.id, e.nome'])
...
$testH2 = NEONQueryBuilder::with($context)::select('e.id AS Codigo, e.nome AS Estado, COUNT(c.id) as num_cidades')
    ->from('estado e')
    ->join('cidade c')
    ->on('e.id = c.estado_id')
    ->group('e.id, e.nome')
...
$testI = NEONQueryBuilder::with($context)::select(['e.*', 'c.*'])
...
$testI1 = NEONQueryBuilder::with($context)::select('e.*, c.*')
    ->from('estado e, cidade c')
    ->where('e.id = 5')
    ->andWhere('c.id = 5');
...
$testJ = NEONQueryBuilder::with($context)::select(['e.*', 'c.*'])
    ->from(['estado e', 'cidade c'])
...
$testJ1 = NEONQueryBuilder::with($context)::select(['e.*', 'c.*'])
    ->from(['estado e', 'cidade c'])
...
$testJ2 = NEONQueryBuilder::with($context)::select('e.*, c.*')
    ->from('estado e, cidade c')
    ->where([['e.id = 10'], ['AND' => 'e.id = 11'], ['AND' => 'e.id = 12']])
    ->andWhere([['e.id = 13'], ['OR' => 'c.id = 14']])
    ->order(['c.id DESC'])
...
// $combinedQuery = NEONQueryBuilder::with($context)::select(['e.id', 'e.nome'])
//     ->from('estado AS e')
//     ->where('e.id', '=', '10')
//     ->union(
//         NEONQueryBuilder::with($context)::select(['c.id', 'c.nome'])
//             ->from('estado AS c')
//             ->where('c.id', '=', 'e.id')
//     )
//     ->union(
//         NEONQueryBuilder::with($context)::select(['d.id', 'd.nome'])
//             ->from('estado AS d')
//             ->where('d.id', '=', 'e.id')
//     );
...
// $query = NEONQueryBuilder::with($context)::select(['*'])
//     ->from('orders AS o')
//     ->where('o.status', '=', 'completed')
//     ->where('o.total_amount', '>', 1000)
//     ->andWhere(
//         NEONQueryBuilder::with($context)::exists(
//             NEONQueryBuilder::with($context)::select(['1'])
//                 ->from('customers c')
//                 ->where('c.id', '=', 'o.customer_id')
//         )
//     )
//     ->orWhere(
//         NEONQueryBuilder::with($context)::notExists(
//             NEONQueryBuilder::with($context)::select(['1'])
//                 ->from('returns r')
...
// var_dump(NEONQueryBuilder::with($context)::getRegexSelect());
// var_dump(NEONQueryBuilder::with($context)::getRegexFrom());
// var_dump(NEONQueryBuilder::with($context)::getRegexOn());
// var_dump(NEONQueryBuilder::with($context)::getRegexGroupOrder());
// var_dump(NEONQueryBuilder::with($context)::getRegexWhereHaving());
