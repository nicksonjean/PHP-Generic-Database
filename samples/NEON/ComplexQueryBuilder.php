...
$qb1 = (new NEONQueryBuilder($context))
...
$qb2 = (new NEONQueryBuilder($context))
...
$qb3 = (new NEONQueryBuilder($context))
...
$qb4 = (new NEONQueryBuilder($context))
...
$qb5 = NEONQueryBuilder::with($context)::distinct('estado_id')
    ->from('cidade')
    ->order('estado_id ASC')
    ->limit('0, 10');
...
$qb6 = (new NEONQueryBuilder($context))
