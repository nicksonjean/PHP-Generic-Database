...
/**
 * Casos de uso: EXISTS, UNION, UNION ALL e Subqueries (Flat File - NEON).
 ...
 * Fontes: estado, cidade (estado.neon, cidade.neon)
 */
...
$qbUnion = (new NEONQueryBuilder($context))
    ->select('nome')
    ->from('estado')
    ->union(
        (new NEONQueryBuilder($context))->select('nome')->from('cidade')
    )
    ->order('nome ASC')
    ->limit('0, 10');
...
$qbUnion2 = (new NEONQueryBuilder($context))
    ->select('nome')
    ->from('estado')
    ->union((new NEONQueryBuilder($context))->select('nome')->from('cidade'))
    ->order('nome ASC')
    ->limit('0, 5');
...
$qbUnionAll = (new NEONQueryBuilder($context))
    ->select('id', 'nome')
    ->from('estado')
    ->unionAll(
        (new NEONQueryBuilder($context))->select('id', 'nome')->from('cidade')
    )
    ->order('nome ASC')
    ->limit('0, 8');
...
$qbExists = (new NEONQueryBuilder($context))
    ->select('e.id', 'e.nome', 'e.sigla')
    ->from('estado e')
    ->whereExists(
        (new NEONQueryBuilder($context))
            ->select('1')
            ->from('cidade c')
...
$qbExists2 = (new NEONQueryBuilder($context))
    ->select('e.id', 'e.nome', 'e.sigla')
    ->from('estado e')
    ->whereExists(
        (new NEONQueryBuilder($context))
...
$qbNotExists = (new NEONQueryBuilder($context))
    ->select('e.id', 'e.nome', 'e.sigla')
    ->from('estado e')
    ->whereNotExists(
        (new NEONQueryBuilder($context))
...
$qbComplex = (new NEONQueryBuilder($context))
...
$qbUnionAllTest13 = (new NEONQueryBuilder($context))
    ->select('id', 'nome')
    ->from('estado')
    ->unionAll(
        (new NEONQueryBuilder($context))->select('id', 'nome')->from('cidade')
