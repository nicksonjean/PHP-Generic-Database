...
$test0 = (new OCIQueryBuilder())->select(['e.id AS Codigo', 'e.nome AS Estado', 'e.sigla AS Sigla'])
    ->from(['estado e'])
    ->where(['e.id >= 25']);
...
$testA = OCIQueryBuilder::select(['e.id AS Codigo', 'e.nome AS Estado', 'e.sigla AS Sigla'])
    ->from(['estado e'])
    ->where(['e.id <= 25']);
...
$testB = (new OCIQueryBuilder())->select('e.id AS Codigo, e.nome AS Estado, e.sigla AS Sigla')
    ->from('estado e')
    ->where('e.id >= 1')
    ->andWhere('e.id <= 5');
...
$testC = OCIQueryBuilder::select(['e.id AS Codigo', 'e.nome AS Estado', 'e.sigla AS Sigla'])
    ->from('estado e')
    ->where('e.id = 6')
    ->orWhere('e.id = 11');
...
$testD = OCIQueryBuilder::select(['e.id AS Codigo', 'e.nome AS Estado', 'e.sigla AS Sigla'])
    ->from('estado e')
...
$testE = OCIQueryBuilder::select(['e.id AS Codigo', 'e.nome AS Estado', 'e.sigla AS Sigla'])
    ->from('estado e')
...
$testF = OCIQueryBuilder::select(['e.id AS Codigo', 'e.nome AS Estado', 'e.sigla AS Sigla'])
    ->from('estado e')
...
$testF1 = OCIQueryBuilder::select(['e.id AS Codigo', 'e.nome AS Estado', 'e.sigla AS Sigla'])
    ->from('estado e')
...
$testG = OCIQueryBuilder::select(['e.id AS Codigo', 'e.nome AS Estado', 'e.sigla AS Sigla'])
    ->from('estado e')
...
$testH1 = OCIQueryBuilder::select(['e.id AS Codigo', 'e.nome AS Estado', 'COUNT(c.id) as num_cidades'])
    ->from(['estado e'])
    ->join(['cidade c'])
    ->on(['e.id = c.estado_id'])
    ->group(['e.id, e.nome'])
...
$testH2 = OCIQueryBuilder::select('e.id AS Codigo, e.nome AS Estado, COUNT(c.id) as num_cidades')
    ->from('estado e')
    ->join('cidade c')
    ->on('e.id = c.estado_id')
    ->group('e.id, e.nome')
...
$testI = OCIQueryBuilder::select(['e.*', 'c.*'])
...
$testI1 = OCIQueryBuilder::select('e.*, c.*')
    ->from('estado e, cidade c')
    ->where('e.id = 5')
    ->andWhere('c.id = 5');
...
$testJ = OCIQueryBuilder::select(['e.*', 'c.*'])
    ->from(['estado e', 'cidade c'])
...
$testJ1 = OCIQueryBuilder::select(['e.*', 'c.*'])
    ->from(['estado e', 'cidade c'])
...
$testJ2 = OCIQueryBuilder::select('e.*, c.*')
    ->from('estado e, cidade c')
    ->where([['e.id = 10'], ['AND' => 'e.id = 11'], ['AND' => 'e.id = 12']])
    ->andWhere([['e.id = 13'], ['OR' => 'c.id = 14']])
    ->order(['c.id DESC'])
...
// $combinedQuery = OCIQueryBuilder::select(['maconha.id', 'maconha.nome'])
//     ->from('estado AS maconha')
//     ->where('maconha.id', '=', 'teste')
//     ->union(
//         OCIQueryBuilder::select(['c.id', 'c.nome'])
//             ->from('estado AS c')
//             ->where('c.id', '=', 'maconha.id')
//     )
//     ->union(
//         OCIQueryBuilder::select(['d.id', 'd.nome'])
//             ->from('estado AS d')
...
// $query = OCIQueryBuilder::select(['*'])
//     ->from('orders AS o')
//     ->where('o.status', '=', 'completed')
//     ->where('o.total_amount', '>', 1000)
//     ->andWhere(
//         OCIQueryBuilder::exists(
//             OCIQueryBuilder::select(['1'])
//                 ->from('customers c')
//                 ->where('c.id', '=', 'o.customer_id')
//         )
//     )
//     ->orWhere(
//         OCIQueryBuilder::notExists(
//             OCIQueryBuilder::select(['1'])
//                 ->from('returns r')
...
// var_dump(OCIQueryBuilder::getRegexSelect());
// var_dump(OCIQueryBuilder::getRegexFrom());
// var_dump(OCIQueryBuilder::getRegexOn());
// var_dump(OCIQueryBuilder::getRegexGroupOrder());
// var_dump(OCIQueryBuilder::getRegexWhereHaving());
