...
$qb1 = (new OCIQueryBuilder($context))
...
$qb2 = (new OCIQueryBuilder($context))
...
$qb3 = (new OCIQueryBuilder($context))
...
$qb4 = (new OCIQueryBuilder($context))
...
$qb5 = OCIQueryBuilder::with($context)::distinct('estado_id')
    ->from('cidade')
    ->order('estado_id ASC')
    ->limit('0, 10');
...
$qb6 = (new OCIQueryBuilder($context))
