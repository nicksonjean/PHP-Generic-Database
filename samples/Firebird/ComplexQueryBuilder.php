...
$qb1 = (new FirebirdQueryBuilder($context))
...
$qb2 = (new FirebirdQueryBuilder($context))
...
$qb3 = (new FirebirdQueryBuilder($context))
...
$qb4 = (new FirebirdQueryBuilder($context))
...
$qb5 = FirebirdQueryBuilder::with($context)::distinct('estado_id')
    ->from('cidade')
    ->order('estado_id ASC')
    ->limit('0, 10');
...
$qb6 = (new FirebirdQueryBuilder($context))
