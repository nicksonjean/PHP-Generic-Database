...
/**
 * Testes complexos com método query() - queries cruas.
 * Mesmos testes em ComplexPrepare.php e ComplexQueryBuilder.php para comparação.
 *
...
$sql2 = 'SELECT e.id AS estado_id, e.nome AS estado_nome, e.sigla, COUNT(c.id) AS total_cidades '
    ...
    . 'ORDER BY total_cidades DESC ROWS 5';
...
$sql3 = 'SELECT e.id AS estado_id, e.nome AS estado_nome, SUM(c.id) AS soma_ids_cidades '
    ...
    . 'ORDER BY soma_ids_cidades DESC ROWS 5';
...
$sql4 = 'SELECT e.id AS estado_id, e.nome AS estado_nome, AVG(c.id) AS media_ids_cidades '
    ...
    . 'GROUP BY e.id, e.nome '
    . 'HAVING AVG(c.id) > 100 '
    . 'ORDER BY media_ids_cidades DESC ROWS 5';
...
$sql5 = 'SELECT DISTINCT estado_id FROM cidade ORDER BY estado_id ASC ROWS 10';
