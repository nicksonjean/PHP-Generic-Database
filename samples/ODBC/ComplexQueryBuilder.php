...
$qb1 = (new ODBCQueryBuilder($context))
...
$qb2 = (new ODBCQueryBuilder($context))
...
$qb3 = (new ODBCQueryBuilder($context))
...
$qb4 = (new ODBCQueryBuilder($context))
...
$qb5 = ODBCQueryBuilder::with($context)::distinct('estado_id')
    ->from('cidade')
    ->order('estado_id ASC')
    ->limit('0, 10');
...
$qb6 = (new ODBCQueryBuilder($context))
