...
$qb1 = (new PDOQueryBuilder($context))
...
$qb2 = (new PDOQueryBuilder($context))
...
$qb3 = (new PDOQueryBuilder($context))
...
$qb4 = (new PDOQueryBuilder($context))
...
$qb5 = PDOQueryBuilder::with($context)::distinct('estado_id')
    ->from('cidade')
    ->order('estado_id ASC')
    ->limit('0, 10');
...
$qb6 = (new PDOQueryBuilder($context))
